...
// Sticky Word Reveal Animation for Section 2 (Pins section sticky until all words reveal)
function initWordSplitScrollAnimation() {
  ...
  // Sticky Pinned ScrollTrigger Timeline: Section 2 pins sticky on screen until all words are revealed
