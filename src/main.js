...
// Scroll-Scrubbed Word-Stacking Animation for Bio Paragraph (No Blur, Clean Word Stack)
function initWordSplitScrollAnimation() {
  ...
  // GSAP ScrollTrigger timeline: scrub 1:1 with scroll position, stacking words clean
