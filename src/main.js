...
// Scroll-Scrubbed Word-Stacking Animation for Bio Paragraph (Right to Left Slide)
function initWordSplitScrollAnimation() {
  ...
  // GSAP ScrollTrigger Timeline: words slide one by one from right to left (x: 35 -> 0)
